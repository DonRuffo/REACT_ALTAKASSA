                ...
                <div className='w-5/6 md:w-4/6'>
                    ...
                    <form>
                        <div className="my-3">
                            ...
                            <input type="email" name='email' placeholder="Enter you email" className="block w-full rounded-md border border-gray-300 focus:border-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-700 py-1 px-2 text-gray-500" />
                        </div>

                        <div className="mb-3">
                            <label className="mb-2 block text-sm font-semibold text-blue-600">Contraseña</label>
                            <input type="password" name='password' placeholder="********************" className="block w-full rounded-md border border-gray-300 focus:border-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-700 py-1 px-2 text-gray-500" />
                        </div>
