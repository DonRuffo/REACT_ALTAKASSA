                    ...
                    <div className="px-5">
                        <section className="flex justify-center mt-20 lg:mt-5 lg:mb-14">
                            <div className="relative overflow-hidden rounded-md shadow-lg w-4/5 lg:w-3/5 py-4.5 bg-gray-100 dark:bg-gray-900 dark:shadow-slate-700 lg:py-10 transition-all duration-300">
                                <h1 className="relative lg:z-10 text-2xl md:text-3xl text-center text-cyan-700 dark:text-cyan-500 font-CalSans px-3 md:px-0">Vista como proveedor</h1>
                                ...
                                <div className="flex lg:hidden justify-center pb-1">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Motivacion.svg'} alt="Proveedor" width={110} height={110} />
                                </div>
                                <div className="absolute z-0 opacity-35 -top-2 left-2 hidden lg:flex justify-center pb-1">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Motivacion.svg'} alt="Proveedor" width={185} height={185} />
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="flex justify-center mt-4">
                            <motion.div layout className="w-4/5 flex justify-center gap-5 flex-wrap transition-all duration-300"
                                ...
                                <motion.div layout id="localitation" className={`${ubiTrabajo ? 'hidden' : ''} relative px-3 flex flex-col dark:bg-gray-900 bg-gray-100 outline-2 outline-emerald-700 ${foto ? '' : 'brightness-50 cursor-not-allowed pointer-events-none outline-0'} h-[260px] w-[200px] rounded-lg items-center justify-center shadow-lg`}>
                                    ...
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Mapa.svg'} alt="localization" width={125} height={125} className={`${carga ? 'hidden' : 'block'}`} />
                                    {carga && <SpinnerCarga />}
                                ...
                                <motion.div layout className={`relative outline-2 outline-emerald-700 ${ubiTrabajo === false || foto === false || revelar ? 'cursor-not-allowed pointer-events-none brightness-50 outline-none' : ''} flex flex-col dark:bg-gray-900 bg-gray-100  h-[260px] w-[200px] rounded-lg items-center justify-center shadow-lg`}>
                                    ...
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Oferta.svg'} alt="logoOferta" width={125} height={125} />
