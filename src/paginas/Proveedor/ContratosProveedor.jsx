...
import CalificacionCli from "../Cliente/CalificacionCli";
                        ...
                        (tra.status === "Agendado" || tra.status === "Completado") && tra.calificacionCliente === null && (
                            <div key={tra._id} className="w-fit h-fit py-3.5 px-5 radial-gradientAceptados-bg rounded-lg shadow-lg shadow-cyan-300 mb-5">
                                ...
                                <div className="flex justify-around mt-2">
                                    ...
                                    <button type="button" data-tooltip-id="cancelar" data-tooltip-content={'Cancelar'} className="flex flex-col justify-center items-center text-red-800 font-semibold hover:scale-105 duration-300 ease-in-out cursor-pointer" onClick={async () => {
