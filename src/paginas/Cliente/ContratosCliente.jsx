...
const ContratosCliente = () => {
    ...
    return (
        <>
            <section>
                <h1 className="text-center text-cyan-700 dark:text-cyan-500 font-CalSans text-3xl mt-20 lg:mt-5">Trabajos actuales</h1>
                        ...
                        trabajos.some(tra => tra.status !== "En espera" && tra.status !== "Cancelado" && tra.status !== "Completado") ? (
                            trabajos.map((tra) => {
                                ...
                                return (
                                    ...
                                    || ((tra.status === "Agendado" || tra.status === "Completado") && tra.calificacionProveedor === null && (selectedOption === "Aceptadas" || selectedOption === "Todas") && (
