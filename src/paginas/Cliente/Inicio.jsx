...
const Inicio = () => {
    const { auth, setAuth, foto, ubiActual, setUbiActual, verificarUbicacionActual, pulseFoto, pulseUbiTra, pulseUbiActual, Perfil, ubiCliente, setUbicacionActual, ivActual } = AuthStoreContext()
