                    ...
                    <>
                        <section className="flex justify-center mt-20 lg:mt-5 mb-5">
                            <div className="relative overflow-hidden rounded-md shadow-lg w-4/5 md:w-3/5 py-4.5 lg:py-10 bg-gray-100 dark:bg-gray-900 dark:shadow-slate-700">
                                ...
                                <div className="absolute opacity-35 z-0 -top-2 left-2 hidden lg:flex justify-center pb-4">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//SVG_Construccion.svg'} alt="Constructor" width={215} height={185} />
                                </div>
                                <div className="lg:hidden flex justify-center pb-1">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//SVG_Construccion.svg'} alt="Constructor" width={110} height={110} />
                                </div>
                            </div>
                        </section><br />
                        <section className={`${foto && ubiActual ? 'hidden' : ''} my-5 flex flex-col justify-center items-center`}>
                            ...
                            <motion.div className="flex justify-center flex-wrap gap-x-5 gap-y-5 lg:gap-y-0"
                                ...
                                <motion.div layout id="localitation" className={`flex flex-col dark:bg-gray-900 bg-gray-100 outline-2 outline-emerald-700 h-[260px] w-[200px] rounded-lg items-center justify-center shadow-lg`}>
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Mapa.svg'} alt="localization" width={125} height={125} />
                                ...
                                {ofFiltradas.length > 0 ? ofFiltradas.map((of, index) => (
                                    <div key={of._id} className="relative flex items-center justify-around md:block radial-gradientOfertas-bg h-fit w-full mx-6 md:mx-0 py-1 md:p-4 md:w-fit md:max-w-48 rounded-lg shadow-lg shadow-cyan-400 mb-5">
                                        ...
                                        <div className="flex flex-col justify-center ">
                                            ...
                                            <h1 className="md:text-center font-bold text-teal-300 text-md md:text-xl md:mb-1">
                                                {of.servicio}
                                            </h1>
                                            <div className="flex justify-center gap-x-3">
                                                <p className="md:text-center font-semibold text-white flex items-center">
                                                    <b className="text-md md:text-xl mr-1 text-teal-300">${of.precioPorDia}</b>
                                                ...
                                                <p className="text-center font-semibold text-white flex items-center">
                                                    <b className="text-md md:text-xl mr-1 text-teal-300">${of.precioPorHora}</b>
                                    ...
                                    <div className="flex flex-col justify-center items-center  bg-gray-100 dark:bg-gray-800 h-[250px] w-[225px] rounded-lg shadow-lg dark:shadow-slate-700 mb-5">
                                        <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Sinofertas.svg'} alt="dreaming" width={125} height={125} />
