            ...
            <div className={darkMode ? "dark" : ""}>
                <main className="bg-white dark:bg-black font-Cabin">
                    ...
                    <section className="relative flex flex-col  items-center justify-center bg-radial from-emerald-200 dark:from-emerald-700 to-70% h-screen">
                        {/*Arriba*/}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute hidden md:block top-22 xl:top-1/5 left-1/3 opacity-40">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.994 15.994 0 0 1 1.622-3.395m3.42 3.42a15.995 15.995 0 0 0 4.764-4.648l3.876-5.814a1.151 1.151 0 0 0-1.597-1.597L14.146 6.32a15.996 15.996 0 0 0-4.649 4.763m3.42 3.42a6.776 6.776 0 0 0-3.42-3.42" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute top-22 xl:top-1/5 opacity-60">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute hidden top-22 xl:top-1/6 lg:block left-1/4 opacity-30">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute top-22 xl:top-1/6 left-1/5 lg:left-2/5 opacity-50">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25" />
                        </svg>

                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute hidden top-22 xl:top-1/6 lg:block right-1/4 opacity-30">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute hidden top-22 xl:top-1/5 md:block right-1/3 opacity-40">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 0 1-.825-.242m9.345-8.334a2.126 2.126 0 0 0-.476-.095 48.64 48.64 0 0 0-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0 0 11.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute top-22 xl:top-1/6 right-1/5 lg:right-2/5 opacity-50">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                        </svg>

                        {/*Abajo*/}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute bottom-1/6 md:bottom-1/12 opacity-60">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute bottom-1/12 md:bottom-1/12 right-1/5 lg:right-2/5 opacity-50">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12 xl:size-14 animate-left-right hover:animate-none absolute bottom-1/12 md:bottom-1/12 left-1/5 lg:left-2/5 opacity-50">
                            ...
                            <div className="w-5/6 lg:w-4/6 py-32">
                                ...
                                <div className="md:flex">
                                    ...
                                    <div className="w-full md:w-2/5 animate-scale-m flex justify-center items-center">
                                        <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Descriptivo.svg'} alt="Floreciendo" width={350} height={250} />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        ...
                        <div className="w-4/5 md:w-11/12 lg:w-4/5">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                                <CardBeneficio Beneficio={"Transparencia"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Transparencia.svg'} texto={"Comunicación abierta y rendición de cuentas en tiempo real entre el cliente y proveedor"} />
                                <CardBeneficio Beneficio={"Garantía"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Garantia.svg'} texto={"¡Calidad de la mano de obra 100% garantizado! Los proveedores son continuamente supervisados para brindar un servicio de calidad."} />
                                <CardBeneficio Beneficio={"Seguridad"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Seguridad.svg'} texto={"¡Alta protección de información! Desde el registro de datos personales hasta la solicitud y cumplimiento de un servicio."} />
                            </div><br /><br /><br /><br />
                            <h2 className="text-4xl font-semibold text-center duration-300 pb-10 dark:text-white">Como proveedor</h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                                <CardBeneficio Beneficio={"Usabilidad"} logo={"https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Usabilidad.svg"} texto={"Sistema óptimo y sencillo de manejar, con un entorno amigable y una clara interfaz para navegar desde cualquier dispositivo."} />
                                <CardBeneficio Beneficio={"Comodidad"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Comodidad.svg'} texto={"Ofrece fácilmente uno o más servicios en la plataforma y consigue ¡nuevos clientes mucho más rápido! desde la comodidad de tu hogar o trabajo."} />
                                <CardBeneficio Beneficio={"Fiabilidad"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Fiabilidad.svg'} texto={"El sistema mantiene credibilidad en sus funciones y prioriza un ambiente de trabajo armónico entre proveedor y cliente, tanto en la plataforma como al prestar el servicio."} />
                            </div><br /><br /><br /><br />
                        </div>
                    </section>
                    <section className="flex py-24 flex-col items-center justify-center bg-radial-[at_0%_50%] from-emerald-200 dark:from-emerald-700 from-1% to-white dark:to-black to-60%" id="Servicios">
                        ...
                        <div className="w-4/5">
                            <div className="flex flex-col md:flex-row items-center md:gap-10">
                                ...
                                <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//ServiciosSection.svg'} alt="Tuerca" width={280} height={250} className="animate-left-inverse" />
                            </div>
                        </div>
                    </section>
                    <section className="flex justify-center">
                        <div className="w-4/5">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-x-8 pb-8 md:pb-10">
                                <CardServicios Servicio1={"Plomería"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Plomeriaa.avif'} texto1={"Un buen sistema de plomería asegura un suministro de agua limpia, previniendo problemas como fugas, obstrucciones y contaminación del agua."} texto2={plomero} />
                                <CardServicios Servicio1={"Carpintería"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Carpinteria.avif'} texto1={"La carpintería combina habilidades técnicas-creativas, fundamental tanto en la construcción como en el diseño de interiores."} texto2={carpintero} />
                                <CardServicios Servicio1={"Pintor"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Pintor%20(1).avif'} texto1={"Aplicación de pinturas y revestimientos en edificios residenciales. Incluye la preparación de superficies mediante limpieza, lijado y reparación de fallas."} texto2={pintor} />
                                <CardServicios Servicio1={"Albañilería"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Albanil.avif'} texto1={"Fundamental en la construcción de infraestructuras, combinando habilidades manuales, técnicas constructivas y normas de seguridad."} texto2={albañil} />
                                <CardServicios Servicio1={"Limpieza"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Limpieza.avif'} texto1={"Profesional especializado en la limpieza general del hogar. Mantener la casa libre de polvo e impurezas es importante para la salud."} texto2={limpieza} />
                                <CardServicios Servicio1={"Téc-Electrodomésticos"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Tecnico.avif'} texto1={"Profesional especializado en la instalación, mantenimiento y reparación de aparatos eléctricos utilizados en el hogar."} texto2={tecnico} />
                                <CardServicios Servicio1={"Electricista"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Electricista.avif'} texto1={"Profesional encargado de instalar, mantener y reparar sistemas eléctricos en viviendas, comercios e industrias."} texto2={tecnico} />
                                <CardServicios Servicio1={"Cerrajero"} logo1={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Cerrajero.avif'} texto1={"Profesional encargado de instalar, reparar y mantener cerraduras, llaves y sistemas de seguridad en puertas, ventanas y otros accesos."} texto2={tecnico} />
                            </div>
                        </div>
                    </section><br /><br /><br /><br />
                        ...
                        <div className="w-full md:w-4/5 py-20">
                            ...
                            <div className="flex flex-col md:flex-row items-center md:justify-center lg:items-start">
                                <div className="w-3/5 flex md:hidden lg:flex justify-center items-start max-h-[300px] pb-5 md:p-0">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//QuienesSomos.svg'} alt="QuienesSomos" width={300} height={250} />
                                </div>
                                <div className="w-4/5 md:full md:pr-5">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//QuienesSomos.svg'} alt="QuienesSomos" width={175} height={150} className="float-left pr-1 hidden md:flex lg:hidden" />
                    ...
                    <section className="relative z-0 flex justify-center bg-gradient-to-b from-white dark:from-black via-cyan-200 dark:via-cyan-800 to-white dark:to-black dark:text-white">
                        ...
                        <div className="w-4/5">
                            ...
                            <div className="flex justify-center">
                                <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Dinamica.svg'} alt="Perfil Dinamica" width={325} height={300} />
                            </div><br /><br />
                            ...
                            {selectedOption === 'cliente' && (
                                <div className={`animate-fade-in`}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-x-6 gap-y-3">
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Agendar.svg'} texto={"Agendar servicios indicando la fecha y hora que más le conviene."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Diversidad.svg'} texto={"Elegir el proveedor de su preferencia o en base a su calificación."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Cancelar1.svg'} texto={"Cancelar una cita o postergarla."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Calificar.svg'} texto={"Calificar al proveedor considerando actitudes, conductas y valores."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Solicitudes.svg'} texto={"Gestionar sus solicitudes a fin de actualizar los requerimientos."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Chatting.svg'} texto={"Comunicarse con el proveedor por mensajería o llamada telefónica."} />
                                    </div><br /><br /><br />
                            ...
                            {selectedOption === 'proveedor' && (
                                <div className={`animate-fade-in`}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-x-6 gap-y-3">
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Ubicacion.svg'} texto={"Revisar el perfil de su cliente y la ubicación para dar el servicio."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Calificar2.svg'} texto={"Calificar al cliente considerando valores como: trato, comportamiento y solvencia."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Precios.svg'} texto={"Ofrecer el precio por consulta o mano de obra a los clientes (considerando el estándar de mínimo y máximo)."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Cancelar2.svg'} texto={"Cancelar o postergar una cita."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//UbiTrabajo.svg'} texto={"Agregar y actualizar la ubicación del lugar de trabajo cada que lo desee."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/public/altakassa//Mensajeria.svg'} texto={"Comunicarse directamente con el cliente mediante el sistema de mensajería o llamada telefónica."} />
                                    </div><br /><br /><br />
                                    <h1 className="text-center text-3xl font-semibold mb-5 text-cyan-600 dark:text-purple-600">Tener en cuenta</h1>
                                    <div className="flex justify-center">
                                        <div className="w-5/6 md:w-1/2">
