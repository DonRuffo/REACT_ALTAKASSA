                    ...
                    <section className="flex flex-col justify-center items-center">
                        ...
                        <div className="w-4/5 md:w-11/12 lg:w-4/5">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                                <CardBeneficio Beneficio={"Transparencia"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Transparencia.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvVHJhbnNwYXJlbmNpYS5zdmciLCJpYXQiOjE3NTE2NzQzNDAsImV4cCI6MjA2NzAzNDM0MH0.IYCDLj__oKFk_dmbeUFOSKPZvSI8CtLnC7pioFYzc_0'} texto={"Comunicación abierta y rendición de cuentas en tiempo real entre el cliente y proveedor"} />
                                <CardBeneficio Beneficio={"Garantía"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Garantia.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvR2FyYW50aWEuc3ZnIiwiaWF0IjoxNzUxNjc3Njk2LCJleHAiOjIwNjcwMzc2OTZ9.wfVDRD6g8n4AHRC_3IAVUH6AUYjbKUou2J--2ksXScc'} texto={"¡Calidad de la mano de obra 100% garantizado! Los proveedores son continuamente supervisados para brindar un servicio de calidad."} />
                                <CardBeneficio Beneficio={"Seguridad"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Seguridad.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvU2VndXJpZGFkLnN2ZyIsImlhdCI6MTc1MTY3NDUxMCwiZXhwIjoyMDY3MDM0NTEwfQ.nWVEzY3VdmAgKdEHo6OdqiQ8NTHJcTu702GcmxQvb3Y'} texto={"¡Alta protección de información! Desde el registro de datos personales hasta la solicitud y cumplimiento de un servicio."} />
                            </div><br /><br /><br /><br />
                            <h2 className="text-4xl font-semibold text-center duration-300 pb-10 dark:text-white">Como proveedor</h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                                <CardBeneficio Beneficio={"Usabilidad"} logo={"https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Usabilidad.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvVXNhYmlsaWRhZC5zdmciLCJpYXQiOjE3NTE2NzQyNTgsImV4cCI6MjA2NzAzNDI1OH0.AGOGL-bVFXgzvKEQQyWUtJK7TYhpLN9zuuxVN9hm-Lc"} texto={"Sistema óptimo y sencillo de manejar, con un entorno amigable y una clara interfaz para navegar desde cualquier dispositivo."} />
                                <CardBeneficio Beneficio={"Comodidad"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Comodidad.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQ29tb2RpZGFkLnN2ZyIsImlhdCI6MTc1MTY3NDE3MCwiZXhwIjoyMDY3MDM0MTcwfQ.ZNdXhCs5V3iTggKEkeEPv8MA3RykyAW1wG_DM4oSV1s'} texto={"Ofrece fácilmente uno o más servicios en la plataforma y consigue ¡nuevos clientes mucho más rápido! desde la comodidad de tu hogar o trabajo."} />
                                <CardBeneficio Beneficio={"Fiabilidad"} logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Fiabilidad.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvRmlhYmlsaWRhZC5zdmciLCJpYXQiOjE3NTE2NzQzMDEsImV4cCI6MjA2NzAzNDMwMX0.rKZmRTNZc1nwUbwAYTh-3FYNs7CGO2N8p9C0sY0FJ3M'} texto={"El sistema mantiene credibilidad en sus funciones y prioriza un ambiente de trabajo armónico entre proveedor y cliente, tanto en la plataforma como al prestar el servicio."} />
                            </div><br /><br /><br /><br />
                        </div>
                    </section>
                        ...
                        <div className="w-full md:w-4/5 py-32">
                            ...
                            <div className="flex flex-col md:flex-row items-center md:justify-center lg:items-start">
                                <div className="w-3/5 flex md:hidden lg:flex justify-center items-start max-h-[300px] pb-5 md:p-0">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/QuienesSomos.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvUXVpZW5lc1NvbW9zLnN2ZyIsImlhdCI6MTc1MTY3NDY4MywiZXhwIjoyMDY3MDM0NjgzfQ.1uJ-FGs1iXDcq-EHAaXuYxMLcUGEKIOKadL-9Akw_Ic'} alt="QuienesSomos" width={300} height={250} />
                                </div>
                                <div className="w-4/5 md:full md:pr-5">
                                    <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/QuienesSomos.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvUXVpZW5lc1NvbW9zLnN2ZyIsImlhdCI6MTc1MTY3NDY4MywiZXhwIjoyMDY3MDM0NjgzfQ.1uJ-FGs1iXDcq-EHAaXuYxMLcUGEKIOKadL-9Akw_Ic'} alt="QuienesSomos" width={175} height={150} className="float-left pr-1 hidden md:flex lg:hidden" />
                    ...
                    <section className="relative z-0 flex justify-center bg-gradient-to-b from-white dark:from-black via-cyan-200 dark:via-cyan-800 to-white dark:to-black dark:text-white">
                        ...
                        <div className="w-4/5">
                            ...
                            <div className="flex justify-center">
                                <img src={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Dinamica.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvRGluYW1pY2Euc3ZnIiwiaWF0IjoxNzUxNjc3Mjg5LCJleHAiOjIwNjcwMzcyODl9._MFMm5evDKK2vobEjHBsMJj9eExazlJLTidGCtlou6s'} alt="Perfil Dinamica" width={325} height={300} />
                            </div><br /><br />
                            ...
                            {selectedOption === 'cliente' && (
                                <div className={`animate-fade-in`}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-x-6 gap-y-3">
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Agendar.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQWdlbmRhci5zdmciLCJpYXQiOjE3NTE2NzQ3MjAsImV4cCI6MjA2NzAzNDcyMH0.jAXIj92ptzMrmXSWwMYwFerLlMK09b59wMxhahXUds4'} texto={"Agendar servicios indicando la fecha y hora que más le conviene."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Diversidad.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvRGl2ZXJzaWRhZC5zdmciLCJpYXQiOjE3NTE2NzQ3NTIsImV4cCI6MjA2NzAzNDc1Mn0.samfJbik44sNRDWQUqwq2TBcwAkjhlzwONV8CiAmN7M'} texto={"Elegir el proveedor de su preferencia o en base a su calificación."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Cancelar1.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQ2FuY2VsYXIxLnN2ZyIsImlhdCI6MTc1MTY3NDc3NSwiZXhwIjoyMDY3MDM0Nzc1fQ.bDfMGhJgU1FFKxfk7_dqbdZyoD8Pn-lR5sLKvhIczSA'} texto={"Cancelar una cita o postergarla."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Calificar.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQ2FsaWZpY2FyLnN2ZyIsImlhdCI6MTc1MTY3NDgxMSwiZXhwIjoyMDY3MDM0ODExfQ.xfzmVK4NSQwnYLsHxy1pitJd9lBrR1qOAfYAMFuwFE4'} texto={"Calificar al proveedor considerando actitudes, conductas y valores."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Solicitudes.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvU29saWNpdHVkZXMuc3ZnIiwiaWF0IjoxNzUxNjc0OTgyLCJleHAiOjIwNjcwMzQ5ODJ9.8F86_q6NXdvMx5-IEJeNvLQsLUF7M4wc2vwryqe86_Y'} texto={"Gestionar sus solicitudes a fin de actualizar los requerimientos."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Chatting.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQ2hhdHRpbmcuc3ZnIiwiaWF0IjoxNzUxNjc1MDEwLCJleHAiOjIwNjcwMzUwMTB9.V7oObcnxqsajIZHcpPjmCacCg6Kf9D9ZqUoGrKFq18w'} texto={"Comunicarse con el proveedor por mensajería o llamada telefónica."} />
                                    </div><br /><br /><br />
                            ...
                            {selectedOption === 'proveedor' && (
                                <div className={`animate-fade-in`}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-x-6 gap-y-3">
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Ubicacion.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvVWJpY2FjaW9uLnN2ZyIsImlhdCI6MTc1MTY3NTA1MCwiZXhwIjoyMDY3MDM1MDUwfQ.hajHQH9-lNFH_1ch1TPnz33CHirL8hsHjUx-Tw1y_oQ'} texto={"Revisar el perfil de su cliente y la ubicación para dar el servicio."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Calificar2.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQ2FsaWZpY2FyMi5zdmciLCJpYXQiOjE3NTE2NzUwNzUsImV4cCI6MjA2NzAzNTA3NX0.YCfRWjkQOtS6MqgT2BIbgv5b21lYlAKKJaa08HAhF7U'} texto={"Calificar al cliente considerando valores como: trato, comportamiento y solvencia."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Precios.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvUHJlY2lvcy5zdmciLCJpYXQiOjE3NTE2NzUwOTksImV4cCI6MjA2NzAzNTA5OX0.l_fmNXhAxxgizqmWrlxQ98G2g-Pv7KuVXzKvxQZUd1U'} texto={"Ofrecer el precio por consulta o mano de obra a los clientes (considerando el estándar de mínimo y máximo)."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Cancelar2.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvQ2FuY2VsYXIyLnN2ZyIsImlhdCI6MTc1MTY3NTEyOCwiZXhwIjoyMDY3MDM1MTI4fQ.IJF5Vk77QBn27SqvBK4P8gDWmVa0aJ7CEP85N4L4w1I'} texto={"Cancelar o postergar una cita."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/UbiTrabajo.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvVWJpVHJhYmFqby5zdmciLCJpYXQiOjE3NTE2NzUxNTksImV4cCI6MjA2NzAzNTE1OX0.zcmWxiqNzlZ7uYTi4L1iKIoTjVLDUY62-9-TedXEtvA'} texto={"Agregar y actualizar la ubicación del lugar de trabajo cada que lo desee."} />
                                        <CardDinamica logo={'https://mqpsbzrziuppiigkbiva.supabase.co/storage/v1/object/sign/altakassa/Mensajeria.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wODIxMTJiNC1kZDliLTQwZWUtYmUxMy1iNDZiMDI3Y2EzYTEiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJhbHRha2Fzc2EvTWVuc2FqZXJpYS5zdmciLCJpYXQiOjE3NTE2Nzc2MzUsImV4cCI6MjA2NzAzNzYzNX0.t0L5fbzgXByW2l3hByA2hn2oC0JWu3cXlnRFMf_mkrg'} texto={"Comunicarse directamente con el cliente mediante el sistema de mensajería o llamada telefónica."} />
                                    </div><br /><br /><br />
                                    <h1 className="text-center text-3xl font-semibold mb-5 text-cyan-600 dark:text-purple-600">Tener en cuenta</h1>
                                    <div className="flex justify-center">
                                        <div className="w-5/6 md:w-1/2">
