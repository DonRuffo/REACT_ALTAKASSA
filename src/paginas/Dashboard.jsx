                ...
                <div className="flex h-screen">
                    <div ref={sideBar} className={`fixed inset-y-0 left-0 w-64 bg-sky-900 dark:bg-gray-950 text-white p-4 transform ${menu === true ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300 ease-in-out lg:static lg:block`}>
                        ...
                        <nav className="py-5 h-[350px] border-b">
                            <Link to='/dashboard' onClick={()=>{handleMenu()}} className="block py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800">
                                <img src={logoInicio} alt="Inicio" width={26} height={26} /><p className=" px-2">Inicio</p>
                            </Link>
                            <Link to='/dashboard/ofertas' onClick={()=>{handleMenu()}} className={`${auth.rol === 'proveedor' ? 'block' : 'hidden'} py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800`}>
                                <img src={logoOfertas} alt="Historial" width={26} height={26} /><p className=" px-2">Tus Ofertas</p>
                            </Link>
                            <Link to='/dashboard/solicitudes/proveedor' onClick={()=>{handleMenu()}} className={`${auth.rol === 'proveedor' ? 'block' : 'hidden'} py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800`}>
                                <img src={logoHistorial} alt="Historial" width={26} height={26} /><p className=" px-2">Solicitudes</p>
                            </Link>
                            <Link to='/dashboard/solicitudes/cliente' onClick={()=>{handleMenu()}} className={`${auth.rol === 'cliente' ? 'block' : 'hidden'} py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800`}>
                                <img src={logoHistorial} alt="Historial" width={26} height={26} /><p className=" px-2">Solicitudes</p>
                            </Link>
                            <Link to='/dashboard/contratos/cliente' onClick={()=>{handleMenu()}} className={`${auth.rol === 'cliente' ? 'block' : 'hidden'} py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800`}>
                                <img src={logoTrabajos} alt="Historial" width={26} height={26} /><p className=" px-2">Trabajos</p>
                            </Link>
                            <Link to='/dashboard/contratos/proveedor' onClick={()=>{handleMenu()}} className={`${auth.rol === 'proveedor' ? 'block' : 'hidden'} py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800`}>
                                <img src={logoTrabajos} alt="Historial" width={26} height={26} /><p className=" px-2">Trabajos</p>
                            </Link>
                            <Link to='/dashboard/historial' onClick={()=>{handleMenu()}} className={`${auth.rol === 'cliente' ? 'block' : 'hidden'} py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800`}>
                            ...
                            <Link to='/dashboard/configuracion' onClick={()=>{handleMenu()}} className="block py-2 px-3 rounded hover:bg-gray-800 duration-100 flex gap-1 focus:bg-gray-800">
