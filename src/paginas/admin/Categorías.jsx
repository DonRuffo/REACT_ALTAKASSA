                    ...
                    <table className="w-full md:w-2/5 rounded-lg overflow-hidden shadow-lg dark:shadow-emerald-900">
                        ...
                        <tbody className="bg-gray-200 dark:bg-gray-900">
                            {categorias.length > 0 ? categorias.map((cat, index) => (
                                <tr key={index}>
                                    <th className="py-1 dark:text-white">{index + 1}</th>
                                    <th className="text-emerald-700 dark:text-emerald-500">{cat.nombre}</th>
                                    <th className="dark:text-white">{cat.suscripciones}</th>
                                    <th className="py-1 flex justify-center text-red-600">
