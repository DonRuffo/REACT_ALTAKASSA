                            ...
                            {categorias.length > 0 ? categorias.map((cat, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="py-1 flex justify-center text-red-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 hover:text-red-700 transition-all duration-300 ease-in-out cursor-pointer" onClick={() => eliminarCat(cat._id, cat.nombre)}>
