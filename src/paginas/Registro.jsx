                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div id="Formulario" className="bg-white dark:bg-black flex items-center justify-center h-screen">
                        <div className="w-4/5 md:4/6">
                            <h1 className="mb-3 font-bold text-xl text-purple-500 text-center">REGISTRO</h1>
                            <hr className="dark:border dark:border-gray-900" />
                            <form onSubmit={HandleSubmit}>
                                <div className="my-3 grid grid-cols-2">
                                    <div className="mx-1">
                                        <label className="mb-2 block text-md font-semibold dark: text-purple-500">Nombre</label>
                                    ...
                                    <div className="mx-1">
                                        <label className="mb-2 block text-md font-semibold dark: text-purple-500">Apellido</label>
                                ...
                                <div className="mb-3 mx-1">
                                    <label className="mb-2 block text-md font-semibold dark: text-purple-500">Dirección</label>
                                ...
                                <div className="mb-3 grid grid-cols-2">
                                    <div className="mx-1">
                                        <label className="mb-2 block text-md font-semibold dark: text-purple-500">Teléfono</label>
                                    ...
                                    <div className="mx-1">
                                        <label className="mb-2 block text-md font-semibold dark: text-purple-500">Correo electrónico</label>
