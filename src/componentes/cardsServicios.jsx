...
const CardServicios = ({ Servicio1, logo1, texto1, texto2 }) => {
    ...
    return (
        <div className="flex flex-col justify-between items-center py-5 md:py-8 relative rounded-xl bg-gray-100 dark:border-none dark:bg-gray-900 shadow-lg shadow-cyan-600 dark:shadow-emerald-600 hover:scale-105 duration-300 ease-in-out">
            <div>
