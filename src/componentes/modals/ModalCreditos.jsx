    ...
    return (
        <>
            <div className="fixed z-40 inset-0 bg-black/70">
                <div className="fixed dark:border-none  top-1/12 md:top-1/5 left-[40px] md:left-[150px] lg:left-[425px] xl:left-[625px] right-[40px] md:right-[150px] lg:right-[200px] xl:right-[625px] min-w-64 lg:min-w-lg bg-gray-100 dark:bg-gray-900 rounded-lg shadow-2xl">
                    ...
                    <div className="px-5 text-justify md:px-8">
                        <p className="dark:text-slate-300 text-base mb-3">Los créditos te permiten realizar trabajos para otros usuarios. Cada trabajo realizado te restará
                    ...
                    <div className="flex justify-center mb-3">
                        <div className="w-5/6 flex flex-col md:flex-row justify-between outline-2 outline-cyan-600 px-4 py-3 rounded-2xl">
                            <div className="w-full md:w-3/5 mb-1 md:mb-0">
                                <h1 className="text-xl dark:text-white mb-2.5">Consigue más créditos</h1>
                                <p className="text-base dark:text-slate-300">Actualiza tu plan y obtén más créditos para elevar tus ingresos y el alcance de tus servicios</p>
                            </div>
