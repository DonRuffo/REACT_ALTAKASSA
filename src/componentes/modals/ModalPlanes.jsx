    ...
    return (
        <>
            <div className="fixed z-40 inset-0 bg-black/70">
                <div className="fixed dark:border-none  top-1/6 left-[40px] md:left-[150px] lg:left-[425px] xl:left-[400px] right-[40px] md:right-[150px] lg:right-[200px] xl:right-[400px] min-w-64 lg:min-w-lg bg-gray-100 dark:bg-gray-900 rounded-lg shadow-2xl">
                    ...
                    <h1 className="text-3xl text-center text-cyan-600 font-CalSans mt-4">Dale un impulso a tus ingresos con más créditos</h1>
