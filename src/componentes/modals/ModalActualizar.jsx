                            ...
                            <form onSubmit={handleSubmitTrabajo}>
                                ...
                                <div className="mb-3 mt-1">
                                    <div className="flex justify-around flex-wrap gap-2 lg:gap-0">
                                        <div className="flex items-center gap-2">
                                            <label htmlFor="precioPorDia" className=" dark:text-white px-3 py-1 has-[input:checked]:text-indigo-800 has-[input:checked]:dark:text-purple-500 has-[input:checked]:border-indigo-800 has-[input:checked]:dark:border-purple-500 rounded-md text-md text-slate-600 font-semibold flex justify-between items-center gap-3 border">
                                                Precio/Dia
                                        ...
                                        <div className="flex items-center gap-2">
                                            <label htmlFor="precioPorHora" className=" dark:text-white px-3 py-1 has-[input:checked]:text-indigo-800 has-[input:checked]:dark:text-purple-500 has-[input:checked]:border-indigo-800 has-[input:checked]:dark:border-purple-500 rounded-md text-md text-slate-600 font-semibold flex justify-between items-center gap-3 border">
                                                Precio/Hora
                                ...
                                <div className="mb-3 mt-7">
                                    <div className="flex justify-around flex-wrap gap-2 lg:gap-0 md:pb-2">
                                        <button type="submit" className="py-2 px-7 font-semibold text-emerald-700 bg-emerald-200 dark:text-emerald-200 dark:bg-emerald-900 hover:brightness-125 rounded-lg duration-300 cursor-pointer" onClick={() => { setTimeout(() => { setModalTraActual(false) }, 3000) }}>Actualizar</button>
                                        <button type="button" className="py-2 px-6 font-semibold text-red-700 bg-red-200 dark:text-red-200 dark:bg-red-900 hover:brightness-125 rounded-lg duration-300 cursor-pointer" onClick={() => { setModalTraActual(!modalTraActual); setMapaCliProv(false) }}>Cerrar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
