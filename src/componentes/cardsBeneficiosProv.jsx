...
const CardBeneficioProv = ({Beneficio, logo, texto }) => {
    return (

        <div className="w-4/5 md:w-1/3 lg:w-1/4 h-[500px] rounded-2xl shadow-2xl outline outline-black/5 dark:shadow-lg dark:shadow-yellow-600">
...
export default CardBeneficioProv